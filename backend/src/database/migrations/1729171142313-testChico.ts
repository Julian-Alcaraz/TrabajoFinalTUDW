...
export class TestChico1729171142313 implements MigrationInterface {
    name = 'TestChico1729171142313'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "fonoaudiologia" ("consultaId" SERIAL NOT NULL, "asistencia" boolean NOT NULL, "diagnosticoPresuntivo" character varying(100) NOT NULL, "causas" character varying(100) NOT NULL, CONSTRAINT "PK_442c8ced49171f77ed4bc773673" PRIMARY KEY ("consultaId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "consulta" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deshabilitado" boolean NOT NULL DEFAULT false, "type" "public"."consulta_type_enum", "obra_social" character varying(100), "edad" integer NOT NULL, "observaciones" text, "usuarioId" integer, "chicoId" integer, "institucionId" integer, "cursoId" integer, CONSTRAINT "REL_36af3728d02bc72fd5b9efd3c3" UNIQUE ("institucionId"), CONSTRAINT "REL_149d4fb8d7e85eb95e5ef11989" UNIQUE ("cursoId"), CONSTRAINT "PK_248230d7f1e2536f83b4d07c955" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "oftalmologia" ("consultaId" SERIAL NOT NULL, "demanda" character varying(100) NOT NULL, "primera_vez" boolean NOT NULL, "control" boolean NOT NULL, "receta" boolean NOT NULL, "prox_control" date NOT NULL, "anteojos" boolean NOT NULL, CONSTRAINT "PK_38d5690043f749ce4c80710cafa" PRIMARY KEY ("consultaId"))`);
