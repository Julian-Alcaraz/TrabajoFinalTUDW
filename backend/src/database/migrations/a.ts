...
export class PrimeraMigracion implements MigrationInterface {
    name = 'PrimeraMigracion~1744214436049'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."clinica_cantidad_comidas_enum" AS ENUM('Mayor a 4', '4', 'Menor a 4', 'Picoteo')`);
        ...
        await queryRunner.query(`CREATE TABLE "consulta" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deshabilitado" boolean NOT NULL DEFAULT false, "type" "public"."consulta_type_enum", "turno" "public"."consulta_turno_enum", "obra_social" boolean, "edad" integer NOT NULL, "observaciones" character varying(1000), "derivacion_oftalmologia" boolean NOT NULL, "derivacion_odontologia" boolean NOT NULL, "derivacion_fonoaudiologia" boolean NOT NULL, "derivacion_externa" boolean NOT NULL, "id_usuario" integer, "id_chico" integer, "id_institucion" integer, "id_curso" integer, CONSTRAINT "PK_248230d7f1e2536f83b4d07c955" PRIMARY KEY ("id"))`);
