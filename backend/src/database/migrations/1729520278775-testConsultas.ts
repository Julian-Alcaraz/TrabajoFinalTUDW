...
export class TestConsultas1729520278775 implements MigrationInterface {
    name = 'TestConsultas1729520278775'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clinica_general" ("id_consulta" integer NOT NULL, "diabetes" boolean NOT NULL, "hta" boolean NOT NULL, "obesidad" boolean NOT NULL, "consumo_alcohol" boolean NOT NULL, "consumo_drogas" boolean NOT NULL, "antecedentes_perinatal" boolean NOT NULL, "enfermedades_previas" boolean NOT NULL, "vacunas" character varying(100) NOT NULL, "peso" double precision NOT NULL, "talla" double precision NOT NULL, "pct" double precision NOT NULL, "cc" double precision NOT NULL, "imc" double precision NOT NULL, "pcimc" double precision NOT NULL, "estado_nutricional" character varying(100) NOT NULL, "tas" double precision NOT NULL, "tad" double precision NOT NULL, "pcta" double precision NOT NULL, "tension_arterial" character varying(100) NOT NULL, "examen_visual" character varying(100) NOT NULL, "ortopedia_traumatologia" character varying(100) NOT NULL, "lenguaje" character varying(100) NOT NULL, "segto" boolean NOT NULL, "alimentacion" character varying(100) NOT NULL, "hidratacion" character varying(100) NOT NULL, "lacteos" boolean NOT NULL, "infusiones" boolean NOT NULL, "numero_comidas" integer NOT NULL, "horas_pantalla" character varying(5) NOT NULL, "horas_juego_airelibre" character varying(5) NOT NULL, "horas_suenio" character varying(5) NOT NULL, "proyecto" character varying(100) NOT NULL, CONSTRAINT "PK_a3e03f04992c0749053714e8450" PRIMARY KEY ("id_consulta"))`);
        await queryRunner.query(`CREATE TABLE "fonoaudiologia" ("id_consulta" integer NOT NULL, "asistencia" boolean NOT NULL, "diagnosticoPresuntivo" character varying(100) NOT NULL, "causas" character varying(100) NOT NULL, CONSTRAINT "PK_7a7cb00668425c025a5faf83fa3" PRIMARY KEY ("id_consulta"))`);
        await queryRunner.query(`CREATE TABLE "odontologia" ("id_consulta" integer NOT NULL, "primera_vez" boolean NOT NULL, "ulterior" boolean NOT NULL, "dientes_permanentes" integer, "dientes_temporales" integer, "sellador" integer, "topificacion" boolean NOT NULL, "cepillado" boolean NOT NULL, "derivacion" boolean NOT NULL, "dientes_recuperables" integer, "dientes_norecuperables" integer, "cepillo" boolean NOT NULL, "habitos" character varying(100) NOT NULL, "situacion_bucal" character varying(100) NOT NULL, "clasificacion" character varying(100) NOT NULL, CONSTRAINT "PK_a13f0d6e808bea7c3bd8067662c" PRIMARY KEY ("id_consulta"))`);
        ...
        await queryRunner.query(`ALTER TABLE "clinica_general" ADD CONSTRAINT "FK_a3e03f04992c0749053714e8450" FOREIGN KEY ("id_consulta") REFERENCES "consulta"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "clinica_general" DROP CONSTRAINT "FK_a3e03f04992c0749053714e8450"`);
