  ...
  public async run(dataSource: DataSource, factoryManager: SeederFactoryManager): Promise<any> {
    try {
      ...
      const barrios = await barrioORM.save([
        ...
        { nombre: 'Nuevo', localidad: cipolletti },
        { nombre: 'Obrero A', localidad: cipolletti },
        { nombre: 'Obrero B', localidad: cipolletti },
        { nombre: 'Santa Elena', localidad: cipolletti },
        { nombre: '130 Viviendas', localidad: cipolletti },
        { nombre: 'La Alameda', localidad: cipolletti },
        { nombre: 'Nueva Esperanza', localidad: cipolletti },
        { nombre: 'Antartida Argentina', localidad: cipolletti },
        { nombre: 'Costa sur', localidad: cipolletti },
        { nombre: 'Puente 83', localidad: cipolletti },
        { nombre: 'San Sebastian', localidad: cipolletti },
        { nombre: '1200 viviendas', localidad: cipolletti },
        { nombre: 'Don Bosco', localidad: cipolletti },
        { nombre: 'San Jose (lomas de Zamora, Bs As)', localidad: buenosAires },
        { nombre: 'Seccion chacras', localidad: cipolletti },
        ...
        { nombre: '4 de febrero', localidad: cipolletti },
        { nombre: '4 de agosto', localidad: cipolletti },
        { nombre: '1 de enero', localidad: cipolletti },
        { nombre: 'Luis Piedra Buena', localidad: cipolletti },
        { nombre: 'Ferri', localidad: cipolletti },
        { nombre: 'Parque Norte', localidad: cipolletti },
        { nombre: 'Obrero Argentino', localidad: cipolletti }, // ESTA REPETIDO CON OBRERO A ? juli: nose lo dejo asi x las dudas
        { nombre: 'Ciudad de la Paz', localidad: cipolletti },
        { nombre: 'Santo Domingo', localidad: cipolletti },
        { nombre: 'distrito noreste', localidad: cipolletti },
        ...
        { nombre: 'Dvn', localidad: cipolletti },
        // Barrios de planilla odontologia
        { nombre: 'Antartida', localidad: cipolletti },
        { nombre: '22 de febrero', localidad: cipolletti },
        { nombre: 'Ana Mapu', localidad: cipolletti },
        { nombre: 'Bouquet Roldan', localidad: cipolletti },
        { nombre: 'Patagonia', localidad: cipolletti },
        { nombre: 'distrito vecinal', localidad: cipolletti },
        { nombre: 'Paraje El 30', localidad: cipolletti },
        // Barrios de planilla oftalmologia
        { nombre: 'Puente de Madera', localidad: cipolletti },
        { nombre: 'La Paz', localidad: cipolletti },
      ]);
