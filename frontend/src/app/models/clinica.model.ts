export class Clinica {
  constructor(
    ...
    public cantidad_comidas: number,
    public horas_pantalla: string,
    public horas_juego_aire_libre: string,
    public horas_suenio: string,
    public proyecto: string,
  ) {}

  static overload_constructor() {
    return new Clinica(0, false, false, false, false, false, false, false,false, '', 0, 0, 0, 0, 0, 0, 0, 0, '', '', '', false, '', '', false, false, 0, '', '', '', '');
  }
}
